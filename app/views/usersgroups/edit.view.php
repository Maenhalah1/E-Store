    ...
    <form action="" method="post" class="form-emp-info">
        <fieldset>
            ...
            <div class="form-field">
                ...
                <input type="text" name="groupname"  value="<?=$group->groupname?>" autocomplete>
            </div>
            <div class="form-field">
                ...
                <?php if(isset($privileges) && $privileges !== false):?>
                    ...
                    <div class="checking-box">
                        <input type="checkbox" name="privileges[]" value="<?=$privilege->get_primary_key()?>" <?=in_array($privilege->get_primary_key(),$privilegesGroup) ? "checked" : ""?>>
